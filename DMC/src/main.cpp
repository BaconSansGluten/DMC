...
#if defined(NDEBUG)
# error "Diamondcoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x55a6b454d095cc51202cbd330447d99252aebd1f044a089cc60b3d0828f33158");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Diamondcoin: starting difficulty is 1 / 2^12
...
{
    // Diamondcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 15000); // Diamondcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1.2 * 24 * 60 * 60; // Diamondcoin: 3.5 days
static const int64 nTargetSpacing = 7 * 60; // Diamondcoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Diamondcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Diamondcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x556eafebe817fa139a4671d8a8def14d8085dc01df0520055c43973adc50f08e");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Lapresse 21/mai/2021 Une manifestation en appui au francais a Montreal";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 30 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04aa5cef31bebaf7220189d6f4abed1886c4b3d1b31690472b550f2a9d19e4bbda2be313568e5857d43f7b48ebd3962a39f79b307d87bba3aee08cc065c8ccbfc3") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1621644119;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084967069;

        if (fTestNet)
        {
            block.nTime    = 1621644091;
            block.nNonce   = 387497920;
        }
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xf95cfdbda9d283680d5f1387c9d27c4cc71f513fb8a509068f277420beb41845"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xda, 0xf5, 0xb6, 0xae }; // Diamondcoin: increase each by adding 2 to bitcoin's value.
...
void static DiamondcoinMiner(CWallet *pwallet)
{
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&DiamondcoinMiner, pwallet));
}
